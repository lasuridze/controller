...
/* Wiegand defines:
 * a Pulse Width time between 20 Î¼s and 100 Î¼s (microseconds)
 * a Pulse Interval time between 200 Î¼s and 20000 Î¼sec
 */
...
void gpio_init(int d0pin, int d1pin) {
    ...
    wiringPiISR(d0pin, INT_EDGE_RISING, d0_pulse);
    wiringPiISR(d1pin, INT_EDGE_RISING, d1_pulse);
